...
async function main() {
	...
	const rpc = 'https://rpc.icicb.com'; // signer.provider.connection.url;
	const explorer = 'https://explorer.icicb.com/'; // signer.provider.connection.url;
	...
	console.log('\tadd tokens',_tokens)
